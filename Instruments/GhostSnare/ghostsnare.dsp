...
resonq = nentry("resonq", 6, 0.1, 100, 0.01);
lowpassfreq = nentry("lowpassfreq", 2000, 20, 20000, 0.001);

RightPush = button("RightPush");

//dry_sound = ( (os.lf_imptrain(1) : en.ar(0.001, 0.15)) * gain * no.noise ) : fi.resonhp(220, 6, 1) : fi.lowpass(2, 2000);

dry_sound = ( (gate : en.ar(0.001, 0.15)) * gain * no.noise ) : fi.resonhp(freq, resonq, 1) : fi.lowpass(4, lowpassfreq);
